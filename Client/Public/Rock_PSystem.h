...
class CRock_PSystem final : public CParticleSystem
{

private:
    CRock_PSystem() = default;
    CRock_PSystem(const CRock_PSystem& Prototype);
    virtual ~CRock_PSystem() = default;
