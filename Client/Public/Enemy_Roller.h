...
class CEnemy_Roller final : public CMonster
{
private:
    CEnemy_Roller() = default;
    CEnemy_Roller(const CEnemy_Roller& Prototype);
    virtual ~CEnemy_Roller() = default;
